...
exports.publishToSubstack = publishToSubstack;
exports.formatBriefAsHTML = formatBriefAsHTML;
...
async function publishToSubstack(brief) {
    ...
    if (SUBSTACK_API_KEY && PUBLICATION_ID) {
        try {
            const res = await axios_1.default.post(`https://api.substack.com/api/v1/publication/${PUBLICATION_ID}/posts`, {
